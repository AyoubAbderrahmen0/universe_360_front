...
const nbreProduct = productBuy?.reduce((acc, product) => {
  ...
  return (
    <div className="navbar">
        ...
        <img src={logo} alt='logo' style={{width:"60px" , height:"60px"}}  className='ms-4 me-2'/>
          <span className='fs-3'>Universe 360</span><span className='fs-6'>.com</span>
        </Link>
        <input
          v-model="searchQ"
          type="text"
  ...
  <path d="M8.707 1.5a1 1 0 0 0-1.414 0L.646 8.146a.5.5 0 0 0 .708.708L2 8.207V13.5A1.5 1.5 0 0 0 3.5 15h9a1.5 1.5 0 0 0 1.5-1.5V8.207l.646.647a.5.5 0 0 0 .708-.708L13 5.793V2.5a.5.5 0 0 0-.5-.5h-1a.5.5 0 0 0-.5.5v1.293zM13 7.207V13.5a.5.5 0 0 1-.5.5h-9a.5.5 0 0 1-.5-.5V7.207l5-5z"/>
        ...
        {client? <Link to={"/account"} className="navbar-item navbar-links d-flex justify-content-center align-items-center rounded-pill p-2" style={{backgroundColor:"#F28C28"}}>
        ...
        {client? 
        <>
        <Button className="navbar-item navbar-links me-4 d-flex justify-content-center align-items-center rounded-pill py-1 px-2" style={{backgroundColor:"#F28C28" , borderColor:"#F28C28" , position: "relative", display: "inline-block"}} onClick={handleShow}>
        {/* L'icône du panier */}
